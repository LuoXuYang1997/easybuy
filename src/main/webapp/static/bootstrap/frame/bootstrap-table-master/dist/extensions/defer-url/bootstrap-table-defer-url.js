 ...
 * bootstrap2-table is to simply throw away any data that currently exists in the
 ...
 * bootstrap2-table to not make that initial request, rather it will use the data
 * already on the page.
 *
 * @author: Ruben Suarez
