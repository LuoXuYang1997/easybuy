...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        this.$container.off('click', '.th-inner').on('click', '.th-inner', function (event) {
            ...
            if (that.options.detailView && !$this.parent().hasClass('bs-checkbox')) {
                if ($this.closest('.bootstrap2-table')[0] !== that.$container[0]) {
                    return false;
                }
            }
        ...
        $(window).off('resize.bootstrap2-table');
        if (!this.options.showHeader || this.options.cardView) {
            ...
            this.getCaret();
            $(window).on('resize.bootstrap2-table', $.proxy(this.resetWidth, this));
        }
    ...
    BootstrapTable.prototype.toggleFullscreen = function () {
        this.$el.closest('.bootstrap2-table').toggleClass('fullscreen');
    };
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        this.each(function () {
            var $this = $(this),
                data = $this.data('bootstrap2.table'),
            ...
            if (typeof option === 'string') {
                ...
                if (option === 'destroy') {
                    $this.removeData('bootstrap2.table');
                }
            }

            if (!data) {
                $this.data('bootstrap2.table', (data = new BootstrapTable(this, options)));
            }
        });
