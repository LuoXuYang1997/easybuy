...
(function () {
    ...
    angular.module('bsTable', [])
        ...
        .directive('bsTableControl', ['uiBsTables', function (uiBsTables) {
            var CONTAINER_SELECTOR = '.bootstrap2-table';
            ...
            $(document)
                .on('post-header.bs.table', CONTAINER_SELECTOR + ' table', function (evt) { // bootstrap2-table calls .off('scroll') in initHeader so reattach here
